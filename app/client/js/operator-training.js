    ...
    const modules = [
        ...
        },
        {
            ...
            buttons: [
                ...
                ['Apply Token Data To Website', 'Copies token name, ticker, use case, supply, allocations, release rules, dapp notes, and ecosystem role into the local website draft.'],
                ['Generate Premium Whitepaper Draft', 'Creates a local section-by-section whitepaper draft from token category, chain, tokenomics, use case, roadmap inputs, dapp modules, risks, and locked-action boundaries.'],
                ['Regenerate Selected Whitepaper Section', 'Rewrites one whitepaper section locally so the owner can tune quality without rebuilding the whole launch package.'],
                ['Generate Realistic Roadmap Draft', 'Creates editable roadmap phases from launch timeline, dapp timeline, community rollout, listing ambition, utility rollout, multi-chain timing, marketing, and treasury/liquidity notes.'],
                ['Save Roadmap Phases', 'Saves roadmap phases with goals, deliverables, owner decisions, dependencies, and locked external actions.'],
                ['Generate Website Intelligence Draft', 'Creates local website sections from the token project, selected logo direction, roadmap, whitepaper, and palette.'],
                ...
                ['Generate Social Launch Kit Drafts', 'Creates local X, Discord, Telegram, Medium, YouTube, website, and whitepaper announcement drafts. It does not post anything.'],
            ...
            fields: [
                ...
                ['Market / circulating supply notes', 'Explain launch float, circulating supply assumptions, unlocks, and future public supply reporting.'],
                ['Multi-chain plan', 'Explain whether the token starts on one chain or expands to additional chains later.'],
                ['Utility summary', 'One sentence EtherealAI can carry into website, whitepaper, roadmap, socials, and launch review.'],
                ['Meme / brand personality', 'Optional voice and visual direction for meme, community, AI, premium, or hybrid positioning.'],
                ['Roadmap source fields', 'Launch timeline, dapp timeline, community timeline, listing ambition, utility rollout, multi-chain timeline, marketing rollout, treasury/liquidity plan, and owner notes.'],
                ...
                ['Website tone', 'Choose the high-level site style, such as premium protocol, meme/community, AI/utility, DeFi, infrastructure, security/trust, or high-conversion launch page.'],
                ...
                ['Roadmap phase fields', 'Goal, deliverables, owner decisions, dependencies, locked external actions, status, and notes for each phase.'],
                ['Whitepaper notes', 'Technical, utility, risk, and limitation notes for the whitepaper.'],
                ['Whitepaper section editor', 'A safer section-by-section editor for executive summary, token overview, use case, utility, tokenomics, architecture, risks, and disclaimer.'],
                ['Social Launch Kit fields', 'Local draft bio, short social bio, community description, announcement, utility explainer, meme/community post, roadmap post, website copy, and whitepaper copy.'],
            ...
            order: [
                ...
                'Click Apply Token Data To Website so token creation data flows into the website draft.',
                'Click Generate Premium Whitepaper Draft and Generate Realistic Roadmap Draft when you want local drafts from the current token inputs.',
                'Edit whitepaper sections and roadmap phases directly if the first draft needs stronger founder language or more realistic dependencies.',
                'Click Generate Website Intelligence Draft to build section-by-section site copy from the token package.',
                ...
                'Generate the Social Launch Kit for local community drafts. Public posting remains locked.',
            ...
            success: [
                ...
                'Whitepaper and roadmap are generated as editable sections/phases instead of one opaque block.',
                'Social Launch Kit drafts are visible locally and public posting remains locked.',
            ...
            video: {
                ...
                chapters: [
                    ...
                    },
                    {
                        ...
                        narration: 'Use this section like a founder draft editor. EtherealAI keeps the token website, premium whitepaper, realistic roadmap, dapp preview, palette, and market-inspiration brief tied to the local token project.',
                        click: 'Click Apply Token Data To Website, Generate Premium Whitepaper Draft, Generate Realistic Roadmap Draft, or Build Local Website Inspiration Brief, then click Save Website / Whitepaper Draft.',
