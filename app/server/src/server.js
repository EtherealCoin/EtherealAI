...
} = require('./lib/exchange-production-execution');
const {
  parseSocialPost,
  reviewSocialContent
...
registerEtherealRoutes(app, {
  ...
  dexMarketDataSetupGuides: DEX_MARKET_DATA_SETUP_GUIDES,
  recommendedReadOnlyExchanges: RECOMMENDED_READONLY_EXCHANGES,
  quoteOnlyConnectors: QUOTE_ONLY_CONNECTORS,
  dexMarketDataConnectors: DEX_MARKET_DATA_CONNECTORS,
  dexQuotePreviewConnectors: DEX_QUOTE_PREVIEW_CONNECTORS,
  ...
  buildTreasuryLiquidityCommandCenter,
  phase6EnableLiveConfirmationPhrase: PHASE6_ENABLE_LIVE_CONFIRMATION_PHRASE,
  phase6OrderConfirmationPhrase: PHASE6_ORDER_CONFIRMATION_PHRASE,
  phase6ApprovalScopeTypes: PHASE6_APPROVAL_SCOPE_TYPES,
  phase6OrderStatuses: PHASE6_ORDER_STATUSES,
  defaultPhase6Policy: DEFAULT_PHASE6_POLICY,
  phase6ProductionAdapters: PHASE6_PRODUCTION_ADAPTERS,
  phase6BRecommendedFirstExchange: PHASE6B_RECOMMENDED_FIRST_EXCHANGE,
  phase6CRecommendedFirstExchange: PHASE6C_RECOMMENDED_FIRST_EXCHANGE,
  phase6DRecommendedFirstExchange: PHASE6D_RECOMMENDED_FIRST_EXCHANGE,
  phase6ERecommendedFirstExchange: PHASE6E_RECOMMENDED_FIRST_EXCHANGE,
  phase6FRecommendedFirstExchange: PHASE6F_RECOMMENDED_FIRST_EXCHANGE,
  phase6FEnableConfirmationPhrase: PHASE6F_ENABLE_CONFIRMATION_PHRASE,
  phase6DArmConfirmationPhrase: PHASE6D_ARM_CONFIRMATION_PHRASE,
  defaultPhase6DTinyLivePolicy: DEFAULT_PHASE6D_TINY_LIVE_POLICY,
  krakenPhase6EWalkthrough: KRAKEN_PHASE6E_WALKTHROUGH,
  phase6BActivationExchangeGuides: PHASE6B_ACTIVATION_EXCHANGE_GUIDES,
  getProductionAdapter,
  getProductionReferenceName,
  sanitizeProductionCredentialInput,
  sanitizeProductionPermissionsChecklist,
