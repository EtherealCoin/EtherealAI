...
function checkLiveTradingLaunchCenterUi() {
  ...
  if (
    ...
    || !html.includes('Run $1 Kraken Tiny Live Test')
    || !html.includes('Preview $1 Kraken Tiny Live Test')
    || !html.includes('Place Tiny Live Test Order')
    || !html.includes('First $1 Live Order Checklist')
    ...
    || !html.includes('one real Kraken spot order at or below $1')
    || !html.includes('Emergency Stop Tiny Test')
    || !html.includes('I APPROVE THIS $1 KRAKEN TINY LIVE TEST')
