...
3. Open `/owner-proof-packet`.
   ...
   - Pass condition: Proof Surfaces include owner proof packet, dashboard readiness, MVP Test Pass, route inventory, Strategy Lab, Social Ops, and Solidity Lab.
...
5. Test Strategy Lab research locally.
   - Save a strategy.
...
9. Test exchange safety metadata.
...
10. Test bot automation in paper/monitor-only mode.
   - Create a bot plan.
...
11. Record local MVP acceptance only after the manual pass is complete.
